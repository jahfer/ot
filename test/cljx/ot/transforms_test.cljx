...
(def op-tom
  [(transforms/->Op :ret 2) (transforms/->Op :ins "a")])
(def op-jerry
  [(transforms/->Op :ret 2) (transforms/->Op :ins "t")])
...
(deftest transform-test
  (testing "Transforming two operations results in the correct pair of functions as response"
    (let [[a' b'] (transforms/transform op-tom op-jerry)
          expect-ops1' [(transforms/->Op :ret 2) (transforms/->Op :ins "a") (transforms/->Op :ret 1)]
          expect-ops2' [(transforms/->Op :ret 3) (transforms/->Op :ins "t")]]
      (is (= a' expect-ops1'))
      (is (= b' expect-ops2')))))

(deftest compress-test
  (testing "#compress will join all neighboring like items"
    (let [ops1 [(transforms/->Op :ret 2) (transforms/->Op :ret 1) (transforms/->Op :ins "a") (transforms/->Op :ret 1) (transforms/->Op :ret 3)]
          ops2 [(transforms/->Op :ret 1) (transforms/->Op :ret 1) (transforms/->Op :ret 1) (transforms/->Op :ret 1) (transforms/->Op :ins "b")]
          result1 (transforms/compress ops1)
          result2 (transforms/compress ops2)]
      (is (= result1 [(transforms/->Op :ret 3) (transforms/->Op :ins "a") (transforms/->Op :ret 4)]))
      (is (= result2 [(transforms/->Op :ret 4) (transforms/->Op :ins "b")])))))

(deftest compose-test
  (testing "Composing two lists of operations results in a single list of all combined operations"
    (let [comp (transforms/compose [(transforms/->Op :ret 1) (transforms/->Op :ins "o")] [(transforms/->Op :ret 2) (transforms/->Op :ins "t")])]
      (is (= comp [(transforms/->Op :ret 1) (transforms/->Op :ins "o") (transforms/->Op :ins "t")])))))
